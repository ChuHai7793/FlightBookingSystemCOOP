...
<div class="container-fluid mt-3">
    <div class="row">
        ...
        <div class="col-md-3 border p-3">
            <a href="../customer/info.jsp?userId=${sessionScope.user.userId}" class="d-block mb-2 text-primary">Thông
                tin cá nhân</a>
            ...
            <table class="table table-bordered table-hover">
                ...
                <c:forEach var="payment_info" items="${payment_infos}">
                    <tr>
                        ...
                        <th scope="col" class="text-start">${payment_info.departure_location}</th>
                        <th scope="col" class="text-start">${payment_info.arrival_location}</th>
                        <th scope="col" class="text-center">${payment_info.booking_date}</th>
                        <th scope="col" class="text-center">${payment_info.travel_date}</th>
                        <th scope="col" class="text-end"><fmt:setLocale value="vi_VN"/>
                            <fmt:formatNumber value="${payment_info.price}" type="currency"/></th>
<%--                        <th scope="col" class="text-center">Hủy</th>--%>
<%--                        <th scope="col" class="text-center">Chọn</th>--%>
                    </tr>
                </c:forEach>
